...
def add_neuropixel2_multishank_in_x(cranial_site_xyz, attack_angle_x, depth, radius=35):
    add_probes_in_x(cranial_site_xyz= cranial_site_xyz, attack_angle_x=attack_angle_x, color="black", depth=depth, radius=radius)
    add_probes_in_x(cranial_site_xyz= cranial_site_xyz, attack_angle_x=attack_angle_x, color="grey", depth=depth-1000, radius=radius+1, mark_true=True)
    return

def add_neuropixel2_multishank_in_y(cranial_site_xyz, attack_angle_x, depth, radius=35):
    add_probes_in_y(cranial_site_xyz= cranial_site_xyz, attack_angle_x=attack_angle_x, color="black", depth=depth, radius=radius)
    add_probes_in_y(cranial_site_xyz= cranial_site_xyz, attack_angle_x=attack_angle_x, color="grey", depth=depth-1000, radius=radius+1, mark_true=True)
    return
...
ca1 = scene.add_brain_region("CA1", alpha=0.5, color=(135,116,172), hemisphere="right", silhouette=True)

#mecl2 = scene.add_brain_region("ENTm2", alpha=0.5, color="blue", hemisphere=None)

#ca1_sp = scene.add_brain_region("CA3", alpha=0.5, color="lime", hemisphere=None)

# if you vary the settings.ROOT_ALPHA to 1 you can determine the depth at which the probes hit the brain surface
# mec probe # and second probe to test the actual depth to the brain surface
mec_cranial_site = np.array([3800,-200,-3200])
mec_implant_depth = 3000
add_probes_in_x(cranial_site_xyz= mec_cranial_site, attack_angle_x=-15, color="black", depth=mec_implant_depth, radius=35)
add_probes_in_x(cranial_site_xyz= mec_cranial_site, attack_angle_x=-15, color="grey", depth=mec_implant_depth-channel_length, radius=36, mark_true=False)

# ca1 probe # and second probe to test the actual depth to the brain surface
ca1_cranial_site = np.array([1500, -1000,-1200])
ca1_implant_depth = 2500
add_probes_in_y(cranial_site_xyz=ca1_cranial_site, attack_angle_x=-15, color="black", depth=ca1_implant_depth, radius=35)
add_probes_in_y(cranial_site_xyz=ca1_cranial_site, attack_angle_x=-15, color="grey", depth=ca1_implant_depth-channel_length, radius=36, mark_true=False)

#mec_cranial_site = np.array([4000,800,-3200])
#mec_implant_depth = 2600
#ca1_cranial_site = np.array([1500, 0,-1200])
#ca1_implant_depth = 1500
#add_neuropixel2_multishank_in_x(cranial_site_xyz= mec_cranial_site, attack_angle_x=-10, depth=mec_implant_depth, radius=35)
#add_neuropixel2_multishank_in_y(cranial_site_xyz= ca1_cranial_site, attack_angle_x=-15, depth=ca1_implant_depth, radius=35)
